...
function renderArticle(Articles) {
  ...
  var a = Articles.developerMessage.results;
  var htmls = a.map(function (Article) {
    return `
			<li class="Article-item-${Article.id}>
				<div class="item-news">
					<a href="#" class="item-news__heading" onclick="showArticle(${Article.id}, Article)">${Article.title}</a>
